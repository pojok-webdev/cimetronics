<div class="tab-pane" id="tab_1_4">
    ...
    <div class="row-fluid portfolio-block">
        <div class="span5 portfolio-text">
            <img src="/assets/metronics/img/profile/portfolio/logo_metronic.jpg" alt="" />
    ...
    <div class="row-fluid portfolio-block">
        <div class="span5 portfolio-text">
            <img src="/assets/metronics/img/profile/portfolio/logo_azteca.jpg" alt="" />
            <div class="portfolio-text-info">
                <h4>Metronic - Responsive Template</h4>
                <p>Lorem ipsum dolor sit consectetuer adipiscing elit.</p>
            </div>
    ...
    <div class="row-fluid portfolio-block">
        <div class="span5 portfolio-text">
            <img src="/assets/metronics/img/profile/portfolio/logo_conquer.jpg" alt="" />
            <div class="portfolio-text-info">
                <h4>Metronic - Responsive Template</h4>
                <p>Lorem ipsum dolor sit consectetuer adipiscing elit.</p>
            </div>
