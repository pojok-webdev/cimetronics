...
<!-- BEGIN HEAD -->
	<?php $this->load->view('commons/metronic_dashboard_header');?>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="page-header-fixed">
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									<div id="site_statistics_loading">
										<img src="/assets/metronics/img/loading.gif" alt="loading" />
									</div>
												...
												<div class="scroller" style="height:290px" data-always-visible="1" data-rail-visible1="1">
													<div class="row-fluid">
														<div class="span6 user-info">
															<img alt="" src="/assets/metronics/img/avatar.png" />
															<div class="details">
																<div>
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" style="height:435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												<img class="avatar" alt="" src="/assets/metronics/img/avatar1.jpg" />
												<div class="message">
											...
											<li class="out">
												<img class="avatar" alt="" src="/assets/metronics/img/avatar2.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="/assets/metronics/img/avatar3.jpg" />
												<div class="message">
													<span class="arrow"></span>
	...
	<!-- END FOOTER -->
	<?php $this->load->view('commons/metronic_dashboard_footer');?>
	<script>
